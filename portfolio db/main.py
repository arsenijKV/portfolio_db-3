...
/skills - добавляет навык выбраному проекту
/projects - показывает проекты
/delete - удаляет проекты
/update_projects - обновляет выбранный вами проект
...
def name_project(message):
    ...
    bot.register_next_step_handler(message,description_name , data=data)

def description_name(message, data):
    description = message.text
    data.append(description)
    bot.send_message(message.chat.id, "Введите сыллка на проект")
